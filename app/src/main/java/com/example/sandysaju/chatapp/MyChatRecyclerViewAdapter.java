...
import com.example.sandysaju.chatapp.ChatFragment.OnListFragmentInteractionListener;
import com.example.sandysaju.chatapp.Data.ChatsViewContent.Conversation;
...
public class MyChatRecyclerViewAdapter extends RecyclerView.Adapter<MyChatRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).senderDisplayName);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mContentView = (TextView) view.findViewById(R.id.displayName);
